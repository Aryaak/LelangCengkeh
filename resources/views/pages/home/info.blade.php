...
<body>
    <div id="app">
        <main class="py-4">
            <div class="mt-3 mx-4">
                <h1 class="fw-bold">LelangCengkeh</h1>
                <hr>

                <h5 class="fw-bold">Selamat datang di LelangCengkeh</h5>
                <p>Syarat & ketentuan yang ditetapkan di bawah ini mengatur pemakaian aplikasi LelangCengkeh terkait
                    transaksi dan penggunaan layanan di LelangCengkeh </p>
                ...
                <ol type="i">
                    <li>LelangCengkeh adalah suatu perseroan terbatas yang menjalankan kegiatan usaha jasa balai lelang
                        dengan merek aplasi mobile LelangCengkeh yakni suatu aplikasi yang menawarkan jasa lelang .</li>
                    ...
                    <li>Syarat & ketentuan adalah perjanjian antara Pengguna dan Developer yang berisikan seperangkat
                        ...
                        penggunaan sistem layanan LelangCengkeh.</li>
                    <li>Pengguna adalah pihak yang menggunakan layanan LelangCengkeh, termasuk namun tidak terbatas pada
                        pembeli, penjual ataupun pihak lain yang sekedar berkunjung ke lelang LelangCengkeh.</li>
                    ...
                    <li>Pemenang lelang adalah peserta lelang yang memenangkan objek lelang di lelang LelangCengkeh dan
                        mendapatkan Konfirmasi Pemenang Lelang (KPL) yang secara resmi dikirimkan oleh LelangCengkeh.
                    </li>
                    <li>Penitip adalah pengguna terdaftar yang menitipkan barang nya untuk menjadi objek lelang pada
                        LelangCengkeh sesuai dengan Perjanjian Kerjasama antara LelangCengkeh dengan Penitip.</li>
                    <li>Penitip adalah pengguna terdaftar yang menitipkan barang nya untuk menjadi objek lelang pada
                        LelangCengkeh sesuai dengan Perjanjian Kerjasama antara LelangCengkeh dengan Penitip.</li>
                </ol>
                ...
                <div>
                    ...
                    <ol type="i">
                        ...
                        <li>LelangCengkeh tidak memungut biaya pendaftaran akun kepada peserta lelang. Pembayaran
                        ...
                        <li>LelangCengkeh tidak akan meminta username, password maupun kode SMS verifikasi atau kode OTP
                            milik akun Peserta lelang untuk alasan apapun, oleh karena itu LelangCengkeh menghimbau
                            Peserta lelang agar tidak memberikan data tersebut maupun data penting lainnya kepada pihak
                            yang mengatasnamakan LelangCengkeh atau pihak lain yang tidak dapat dijamin keamanannya.
                        </li>
                    </ol>
                </div>
                ...
                <div>
                    ...
                    <a href="" name="setuju" class="btn btn-success w-100" disabled="true">Setuju dan lanjutkan</a>
                </div>
            </div>
        </main>
    </div>
    ...
    <script>
        $("input[type=checkbox]").on("change", function(evt) {
            ...
            if (validasi.length == 0) {
                $("a[name=setuju]").prop("disabled", true);
                $("a[name=setuju]").prop("href", "");
            } else {
                $("a[name=setuju]").prop("disabled", false);
                $("a[name=setuju]").prop("href", "/home");
            }
        });
    </script>
</body>
