                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address"  class="form-control @error('address') is-invalid @enderror" cols="30" rows="5" autocomplete="address" required>{{ old('address') }}</textarea>
